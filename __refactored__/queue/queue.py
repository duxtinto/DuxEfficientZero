...
class Queue:
    ...
    def size(self, _ray_trace_ctx: Optional[Context] = None) -> int:
        """The size of the queue."""
        return ray.get(self.actor.qsize.remote())

    def qsize(self, _ray_trace_ctx: Optional[Context] = None) -> int:
        """The size of the queue."""
        return self.size()

    def empty(self, _ray_trace_ctx: Optional[Context] = None) -> bool:
        """Whether the queue is empty."""
        return ray.get(self.actor.empty.remote())

    def full(self, _ray_trace_ctx: Optional[Context] = None) -> bool:
        """Whether the queue is full."""
        return ray.get(self.actor.full.remote())

    def put(
        self, item: Any, block: bool = True, timeout: Optional[float] = None, _ray_trace_ctx: Optional[Context] = None
    ) -> None:
    ...
    def get(self, block: bool = True, timeout: Optional[float] = None, _ray_trace_ctx: Optional[Context] = None) -> Any:
    ...
    async def get_async(
        self, block: bool = True, timeout: Optional[float] = None, _ray_trace_ctx: Optional[Context] = None
    ) -> Any:
        """Gets an item from the queue.
    ...
    def put_nowait(self, item: Any, _ray_trace_ctx: Optional[Context] = None) -> None:
    ...
    def put_nowait_batch(self, items: Iterable, _ray_trace_ctx: Optional[Context] = None) -> None:
    ...
    def get_nowait(self, _ray_trace_ctx: Optional[Context] = None) -> Any:
    ...
    def get_nowait_batch(self, num_items: int, _ray_trace_ctx: Optional[Context] = None) -> List[Any]:
    ...
    def shutdown(self, force: bool = False, grace_period_s: int = 5, _ray_trace_ctx: Optional[Context] = None) -> None:
...
class _QueueActor:
    ...
    def qsize(self, _ray_trace_ctx: Optional[Context] = None):
        return self.queue.qsize()

    def empty(self, _ray_trace_ctx: Optional[Context] = None):
        return self.queue.empty()

    def full(self, _ray_trace_ctx: Optional[Context] = None):
        return self.queue.full()

    async def put(self, item, timeout=None, _ray_trace_ctx: Optional[Context] = None):
        try:
            await asyncio.wait_for(self.queue.put(item), timeout)
        except asyncio.TimeoutError:
            raise Full

    async def get(self, timeout=None, _ray_trace_ctx: Optional[Context] = None):
        try:
            return await asyncio.wait_for(self.queue.get(), timeout)
        except asyncio.TimeoutError:
            raise Empty

    def put_nowait(self, item, _ray_trace_ctx: Optional[Context] = None):
        self.queue.put_nowait(item)

    def put_nowait_batch(self, items, _ray_trace_ctx: Optional[Context] = None):
    ...
    def get_nowait(self, _ray_trace_ctx: Optional[Context] = None):
        return self.queue.get_nowait()

    def get_nowait_batch(self, num_items, _ray_trace_ctx: Optional[Context] = None):
